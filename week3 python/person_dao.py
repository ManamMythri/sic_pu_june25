...
class Db_operations:
    ...
    def connect_db(self):
        try:
            connection = pymysql.Connect(host='localhost', port=3306, user='root', password='mythri@22', database='person_db', charset='utf8')
            print('DB connected')
            return connection
        except:
    ...
    def create_db(self):
        ...
        query = 'create database IF NOT EXISTS person_db;'
